...
public class CongressAnalyzer {
    ...
    private List<CongressMember> congressMemberListOriginal;
    private List<CongressMember> congressMemberListCopy;

    public CongressAnalyzer(List<CongressMember> congressMemberList) {
        this.congressMemberListOriginal = congressMemberList;
        this.congressMemberListCopy = congressMemberList;
    }
    ...
    public CongressMember findCongressMemberByName(String firstName, String lastName) {
        ...
        for (CongressMember congressMember : congressMemberListCopy) {
    ...
    public HashMap<String, Double> averageAgeByParty(){
        ...
        for (int i = 0; i < congressMemberListCopy.size(); i++){
            List<Term> termList = congressMemberListCopy.get(i).getTermList();
            String party = congressMemberListCopy.get(i).getTermList().get(termList.size()-1).getParty();
            int age = congressMemberListCopy.get(i).getCongressMemberAge();
